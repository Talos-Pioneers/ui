        ...
        <Transition name="fade" mode="out-in">
            ...
            <div v-if="!isSubmitted" key="form">
                ...
                <div class="text-center mb-6">
                    <h1
                        ...
                        <span class="text-cool-gray-40 font-sans">[</span> {{ t('auth.login.title') }} <span
                ...
                <div class="mb-4">
                    <div class="relative">
                        ...
                        <Input v-model="email" class="pl-10" type="email" :placeholder="t('auth.login.emailPlaceholder')" />
                ...
                <div class="flex justify-between mb-4 text-sm">
                    <button class="text-[#1b1b18] dark:text-[#EDEDEC] hover:underline" @click="close(); openRegister()">
                ...
                <div class="flex flex-col gap-3">
                    <Button class="bg-transparent" as="a" :href="googleUrl" variant="outline" rounded="base" :with-wave="false">
                        <GoogleIcon />
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC] font-medium">{{ t('auth.common.googleLogin') }}</span>
                    </Button>
                    <Button class="bg-transparent" as="a" :href="discordUrl" variant="outline" rounded="base" :with-wave="false">
                        <DiscordIcon />
                        <span class="text-[#1b1b18] dark:text-[#EDEDEC] font-medium">{{ t('auth.common.discordLogin') }}</span>
                    </Button>
                </div>
            </div>
            ...
            <div v-else key="success" class="text-center">
                ...
                <div class="text-center mb-6">
                    <h1
                        class="text-[2rem] h-8 font-secondary flex justify-center items-center gap-5 font-black text-cool-gray-90 mb-2">
                        <span class="text-cool-gray-40 font-sans">[</span> {{ t('auth.login.successTitle') }} <span
                            class="text-cool-gray-40 font-sans">]</span>
                    </h1>
                    <!-- Placeholder for special font glyphs -->
                    <div class="text-sm text-cool-gray-40 font-sarkaz">
