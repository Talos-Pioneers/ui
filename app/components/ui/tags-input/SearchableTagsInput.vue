...
// const testSearchableOptions: SearchableOption[] = [
//   {
//     value: 'apple',
//     label: 'Apple'
//   },
    ...
    <ComboboxAnchor>
      ...
      >
        <TagsInputItem
            ...
            :value="item.toString()"
        >
          <span class="py-0.5 px-2 text-sm rounded bg-transparent">{{props.options.find(opt => opt.value === item)?.label ?? "balls"}}</span>
        ...
        <ComboboxTrigger as-child>
          <Button size="icon-sm" variant="ghost" class="order-last self-start ml-auto" type="button">
