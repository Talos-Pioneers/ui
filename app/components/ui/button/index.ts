...
export const buttonVariants = cva(
		...
		'focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-no-repeat bg-center bg-cover',
	{
		variants: {
			variant: {
				default:
					'bg-primary text-primary-foreground hover:bg-primary-hover before:border-foreground/30',
				destructive:
			...
			size: {
				...
				'icon-lg': 'size-10',
				'responsive-icon':
					'size-10 navd:h-11.5 navd:w-auto navd:px-4 navd:py-2 navd:has-[>svg]:px-3',
			},
			rounded: {
				default:
